...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'pointcloud.allow_no_texture_points','default': 'false', 'description': 'texture stream index for pointcloud'},
...
def launch_setup(context:LaunchContext, *args, **kwargs):
    _camera_name = LaunchConfiguration("camera_name").perform(context)
    _config_file = LaunchConfiguration("config_file").perform(context)
    params_from_file = {} if _config_file == "''" else yaml_to_dict(_config_file)
    params_from_file = params_from_file[_camera_name]['ros__parameters']
    log_level = 'info'
    # Realsense
